...
"[project]/cginfrax/src/models/Otp.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$cginfrax$2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/cginfrax/node_modules/mongoose)");
;
const otpSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$cginfrax$2f$node_modules$2f$mongoose$29$__["default"].Schema({
    email: {
        type: String,
        required: true
    },
...
const Otp = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$cginfrax$2f$node_modules$2f$mongoose$29$__["default"].models.Otp || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$cginfrax$2f$node_modules$2f$mongoose$29$__["default"].model("Otp", otpSchema);
}),
...
"[project]/cginfrax/src/app/api/auth/send-otp/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$src$2f$models$2f$Otp$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/cginfrax/src/models/Otp.js [app-route] (ecmascript)");
...
const POST = async (request)=>{
    try {
        ...
        if (!body.email) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Email is required", {
                status: 400
            });
        }
        ...
        if (!emailRegex.test(email)) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Invalid email format", {
                status: 400
            });
        }
        ...
        if (existingUser) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("User already exists with this email", {
                status: 400
            });
        }
        // 2. 🔥 MAIN STEP: Purana OTP delete karo (Agar koi pending hai to)
        await __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$src$2f$models$2f$Otp$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Otp"].deleteMany({
            email
        });
        // 3. Naya OTP Generate aur Save karo
        const otpValue = Math.floor(100000 + Math.random() * 900000).toString();
        await __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$src$2f$models$2f$Otp$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Otp"].create({
            email,
            otp: otpValue
        });
        // 4. Email Bhejo
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("OTP Sent Successfully", {
            status: 200
        });
    } catch (err) {
        console.error("Send OTP Error:", err);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$cginfrax$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Failed to send OTP", {
            status: 500
        });
    }
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd455cd6._.js.map